<?php
	...
	if(isset($_GET["id"])){
		...
		"SELECT * From blogs WHERE id =".$_GET["id"]);
...
<?php include "views/header.php"; ?>
	...
	<section class="container page">
		<div class="page-block">
			...
			<form class="form" action="<?=$BASE_URL?>/api/blog/update.php?id=<?=$_GET["id"]?>" method="POST" enctype="multipart/form-data">
				...
				<select name="category_id" id="" class="input">
					<?php
						$categ = mysqli_query($con, "SELECT * FROM categories");
